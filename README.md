...
- **Note2QuizAI** (Team project, 3 developers) — AI-powered quiz generator using ASP.NET Core, React, Azure AI Vision, and Azure OpenAI. Implemented OpenAI quiz generation pipeline, quiz submission and scoring logic, and REST API endpoints with service-layer orchestration.
